...
let nvToolchainInfo =
      R.typedProvider "NvToolchainInfo"
        [ R.typedField "nvidia_sdk_path" "str"
        , R.typedField "nvidia_sdk_include" "str"
        , R.typedField "nvidia_sdk_lib" "str"
        , R.typedField "nv_archs" "list[str]"
        ]

let nvLibraryInfo =
      R.typedProvider "NvLibraryInfo"
        [ R.typedField "objects" "list"
        , R.typedField "headers" "list"
        , R.typedField "include_dir" "str"
        ]
...
'')
      ...
      , attrs =
          ...
          , R.stringAttr "nvidia_sdk_path" (Some "/usr/local/cuda")
          , R.stringAttr "nvidia_sdk_include" (Some "/usr/local/cuda/include")
          , R.stringAttr "nvidia_sdk_lib" (Some "/usr/local/cuda/lib64")
          ]
      }
...
''
      , attrs =
          [ R.sourceListAttr "srcs"
          , R.sourceListAttr "exported_headers"
          , R.depListAttr "deps"
          ]
      }
...
''
        ...
        with providers = [ nvToolchainInfo, nvLibraryInfo ]
        with rules =
            [ nvToolchain
            , nvBinary
            , nvLibrary
