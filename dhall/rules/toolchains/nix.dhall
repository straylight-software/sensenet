...
--|
--| Resolves nixpkgs#foo to store paths at analysis time via config.
--| The store paths are then used as prebuilt_cxx_library deps.
--|
--| Note: nix_cxx_library is a macro that creates native.prebuilt_cxx_library
--| and is included in globals as raw starlark.
...
let cxxPrebuiltLibraryInfo =
      R.simpleProvider "CxxPrebuiltLibraryInfo"
        [ "include_dirs"
        , "lib_dir"
        , "lib_name"
        ]
...
-- ══════════════════════════════════════════════════════════════════════════════
-- Globals (macros and helper data)
-- ══════════════════════════════════════════════════════════════════════════════
...
''
        ...
        with providers = [ cxxPrebuiltLibraryInfo ]
        with rules = [ nixPrebuilt ]
