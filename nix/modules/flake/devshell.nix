            ...
            shellHook =
              let
                ...
                buckconfig-local-content = ''
                  ...
                  ar = ${lld}/bin/llvm-ar
                  ld = ${lld}/bin/ld.lld
                  clang_resource_dir = ${clang}/resource-root
                  gcc_include = ${pkgs.gcc.cc}/include/c++/${pkgs.gcc.cc.version}
                  gcc_include_arch = ${pkgs.gcc.cc}/include/c++/${pkgs.gcc.cc.version}/${pkgs.stdenv.hostPlatform.config}
                  glibc_include = ${pkgs.glibc.dev}/include
                  gcc_lib = ${pkgs.gcc.cc}/lib/gcc/${pkgs.stdenv.hostPlatform.config}/${pkgs.gcc.cc.version}
                  gcc_lib_base = ${pkgs.gcc.cc.lib}/lib
                  glibc_lib = ${pkgs.glibc}/lib

                  ${nv-config}

                  [haskell]
                  ghc = ${ghc-with-all-deps}/bin/ghc
                  ghc_pkg = ${ghc-with-all-deps}/bin/ghc-pkg
                  haddock = ${ghc-with-all-deps}/bin/haddock
                  ghc_version = 9.12.2
                  ghc_lib_dir = ${ghc-with-all-deps}/lib/ghc-9.12.2/lib
                  global_package_db = ${ghc-with-all-deps}/lib/ghc-9.12.2/lib/package.conf.d
                  ...
                  python_include = ${pkgs.python3}/include/python3.12
