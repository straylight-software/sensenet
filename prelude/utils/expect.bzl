...
#
# Extracted from buck2-prelude utils/expect.bzl
#
...
load(":type_defs.bzl", "is_bool", "is_collection", "is_dict", "is_list", "is_number", "is_string", "is_struct")
...
# Convenience struct for importing all expects at once
expects = struct(
    expect = expect,
    type = expect_type,
