# prelude/apple/apple_target_sdk_version.bzl
#
# Extracted from buck2-prelude

load("@straylight_prelude//apple:versions.bzl", "TARGET_SDK_VERSIONS")
load("@straylight_prelude//cxx:target_sdk_version.bzl", "get_target_sdk_version")
