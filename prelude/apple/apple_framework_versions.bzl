...
# Framework SDK version information for weak linking.

load("@straylight_prelude//apple:apple_sdk.bzl", "get_apple_sdk_name")
load("@straylight_prelude//apple:apple_target_sdk_version.bzl", "get_min_deployment_version_for_node")
load("@straylight_prelude//apple:apple_utility.bzl", "has_apple_toolchain")
