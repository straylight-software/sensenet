...
# Swift support stubbed out - we don't support Swift.

load("@straylight_prelude//:paths.bzl", "paths")
load(
    "@straylight_prelude//linking:link_info.bzl",
    "FrameworksLinkable",
    "LinkArgs",
    "LinkInfo",
    "LinkStrategy",
...
load("@straylight_prelude//apple:apple_framework_versions.bzl", "get_framework_linker_args", "validate_sdk_frameworks")
...
# ============================================================================
# Swift support stubs
# We don't support Swift, so these functions return empty results.
# ============================================================================

def extract_swiftmodule_linkables(infos: list[[LinkInfo, None]]) -> list[SwiftmoduleLinkable]:
    """Stubbed - Swift is not supported. Returns empty list."""
    return []

def get_swiftmodule_linker_flags(ctx: AnalysisContext, linkable: [SwiftmoduleLinkable, None]) -> cmd_args:
    """Stubbed - Swift is not supported. Returns empty cmd_args."""
    return cmd_args()

# ============================================================================
# Main framework linking functions
# ============================================================================
