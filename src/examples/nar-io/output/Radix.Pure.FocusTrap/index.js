...
var focusFirst = function (scope) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 137, column 3 - line 139, column 49): " + [ v.constructor.name ]);
    };
};
var focusLast = function (scope) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 145, column 3 - line 147, column 49): " + [ v.constructor.name ]);
    };
};
        ...
        return function __do() {
            ...
            if (mIndex instanceof Data_Maybe.Just && (mIndex.value0 === 0 && isShift)) {
                (function () {
                    ...
                    throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 118, column 11 - line 120, column 33): " + [ last.constructor.name ]);
                })();
                return true;
            };
            if (mIndex instanceof Data_Maybe.Just && (!isShift && mIndex.value0 === (Data_Array.length(tabbable) - 1 | 0))) {
                (function () {
                    ...
                    throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 125, column 11 - line 127, column 33): " + [ first.constructor.name ]);
                })();
                return true;
            };
            return false;
...
var trapFocus = function (scope) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 85, column 3 - line 87, column 49): " + [ v.constructor.name ]);
    };
};
    ...
    var removeGuard = function (v) {
        if (v instanceof Data_Maybe.Just) {
            return function __do() {
                ...
                throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 75, column 7 - line 77, column 29): " + [ mParent.constructor.name ]);
            };
        };
        if (v instanceof Data_Maybe.Nothing) {
            return pure(Data_Unit.unit);
        };
        throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 72, column 17 - line 78, column 25): " + [ v.constructor.name ]);
    };
    return function __do() {
        ...
        throw new Error("Failed pattern match at Radix.Pure.FocusTrap (line 67, column 3 - line 69, column 25): " + [ scope.previousActiveElement.constructor.name ]);
    };
};
