...
var prevEnabledTab = function (indices) {
    return function (mCurrent) {
        return function (loop) {
            ...
            throw new Error("Failed pattern match at Radix.Pure.Tabs (line 303, column 3 - line 309, column 39): " + [ mCurrent.constructor.name ]);
        };
    };
};
var orientationStr = function (v) {
    ...
    throw new Error("Failed pattern match at Radix.Pure.Tabs (line 223, column 1 - line 223, column 40): " + [ v.constructor.name ]);
};
...
var nextEnabledTab = function (indices) {
    return function (mCurrent) {
        return function (loop) {
            ...
            throw new Error("Failed pattern match at Radix.Pure.Tabs (line 292, column 3 - line 298, column 39): " + [ mCurrent.constructor.name ]);
        };
    };
};
    ...
    var getInitialValue = function (i) {
        ...
        if (i.value instanceof Data_Maybe.Nothing) {
            ...
            if (i.defaultValue instanceof Data_Maybe.Nothing) {
                ...
                throw new Error("Failed pattern match at Radix.Pure.Tabs (line 138, column 20 - line 140, column 24): " + [ v.constructor.name ]);
            };
            throw new Error("Failed pattern match at Radix.Pure.Tabs (line 136, column 18 - line 140, column 24): " + [ i.defaultValue.constructor.name ]);
        };
        throw new Error("Failed pattern match at Radix.Pure.Tabs (line 134, column 5 - line 140, column 24): " + [ i.value.constructor.name ]);
    };
    return {
    ...
    return function (v) {
        ...
        if (v instanceof Receive) {
            return discard((function () {
                ...
                throw new Error("Failed pattern match at Radix.Pure.Tabs (line 237, column 5 - line 242, column 27): " + [ v.value0.value.constructor.name ]);
            })())(function () {
            ...
            return bind(get)(function (state) {
                ...
                return for_(nextIdx)(function (idx) {
                    return discard(liftEffect(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                        ...
                        throw new Error("Failed pattern match at Radix.Pure.Tabs (line 276, column 7 - line 287, column 29): " + [ v1.constructor.name ]);
                    });
                });
            });
        };
        throw new Error("Failed pattern match at Radix.Pure.Tabs (line 232, column 16 - line 287, column 29): " + [ v.constructor.name ]);
    };
};
var handleQuery = function (dictMonadAff) {
    ...
    return function (v) {
        ...
        throw new Error("Failed pattern match at Radix.Pure.Tabs (line 322, column 15 - line 329, column 44): " + [ v.constructor.name ]);
    };
};
