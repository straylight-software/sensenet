{- This file was auto-generated from google/rpc/status.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Google.Rpc.Status (
        Status()
    ) where
...
{- | Fields :
         ...
         * 'Proto.Google.Rpc.Status_Fields.code' @:: Lens' Status Data.Int.Int32@
         * 'Proto.Google.Rpc.Status_Fields.message' @:: Lens' Status Data.Text.Text@
         * 'Proto.Google.Rpc.Status_Fields.details' @:: Lens' Status [Proto.Google.Protobuf.Any.Any]@
         * 'Proto.Google.Rpc.Status_Fields.vec'details' @:: Lens' Status (Data.Vector.Vector Proto.Google.Protobuf.Any.Any)@ -}
data Status
...
packedFileDescriptor
  = "\n\
    \\ETBgoogle/rpc/status.proto\DC2\n\
    \google.rpc\SUB\EMgoogle/protobuf/any.proto\"f\n\
    \\ACKStatus\DC2\DC2\n\
    \\EOTcode\CAN\SOH \SOH(\ENQR\EOTcode\DC2\CAN\n\
    \\amessage\CAN\STX \SOH(\tR\amessage\DC2.\n\
    \\adetails\CAN\ETX \ETX(\v2\DC4.google.protobuf.AnyR\adetailsBa\n\
    \\SOcom.google.rpcB\vStatusProtoP\SOHZ7google.golang.org/genproto/googleapis/rpc/status;status\248\SOH\SOH\162\STX\ETXRPCJ\132\SO\n\
    \\ACK\DC2\EOT\SO\NUL0\SOH\n\
    \\188\EOT\n\
    ...
    \\b\n\
    \\SOH\b\DC2\ETX\NAK\NULN\n\
    \\t\n\
    \\STX\b\v\DC2\ETX\NAK\NULN\n\
    \\b\n\
    ...
    \\190\ETX\n\
    \\STX\EOT\NUL\DC2\EOT\"\NUL0\SOH\SUB\177\ETX The `Status` type defines a logical error model that is suitable for\n\
    ...
    \y\n\
    \\EOT\EOT\NUL\STX\STX\DC2\ETX/\STX+\SUBl A list of messages that carry the error details.  There is a common set of\n\
    ...
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\STX\ACK\DC2\ETX/\v\RS\n\
    \\f\n\
