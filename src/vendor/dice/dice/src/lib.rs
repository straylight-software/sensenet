...
// NOTE: Nightly features removed for stable Rust compatibility
// Original: #![feature(fn_traits)] - replaced with explicit .call() syntax
// Original: #![feature(test)] - bench tests disabled
// Original: #![feature(map_try_insert)] - replaced with entry() API
